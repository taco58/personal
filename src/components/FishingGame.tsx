...
const FISH_ITEMS: FishItem[] = [
  {
    ...
    icon: "🐟",
    rarity: "Common",
    description: "Pacific Northwest freshwater classic.",
  },
  {
    id: "crab",
    name: "Dungeness Crab",
    icon: "🦀",
    rarity: "Uncommon",
    description: "Vancouver coastal delicacy. Pinches with low latency.",
  },
  {
    id: "boot",
    name: "Old Boot",
  ...
  },
  {
    ...
    icon: "💀",
    rarity: "Rare",
    description: "Dangling in the heap. Segfaults if you inspect it too closely.",
  },
  {
    id: "cookie",
    ...
    icon: "🍪",
    rarity: "Uncommon",
    description: "Legendary UBC campus fuel for late-night debugging.",
  },
  {
    id: "duck",
    name: "Rubber Duck",
